...
如果你想在它们被转换为 Eloquent 模型前得到原始数据，你应该使用`raw` 方法:

    $orders = App\Order::search('Star Trek')->raw();

检索查询通常会在模型的[`searchableAs`](#configuring-model-indexes)方法指定的索引上执行。当然，你也可以使用 `within` 方法指定应该搜索的自定义索引:
...
| 用户名 | 头像 | 职能 | 签名 |
|---|---|---|---|
| [@Insua](https://phphub.org/users/3853)  | <img class="avatar-66 rm-style" src="http://upload.jianshu.io/users/upload_avatars/2587416/ec8cb56a3c48?imageMogr2/auto-orient/strip|imageView2/1/w/380/h/380">  |  翻译  |  [@Insua](https://github.com/Insua) at Github  |
