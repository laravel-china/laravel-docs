...
return [
    ...
    [
        'text' => '配置信息',
        'link' => '/docs/{{version}}/configuration'
    ],
    [
        'text' => '文件夹结构',
    ...
    [
        'text' => '广播系统',
        'link' => '/docs/{{version}}/broadcasting'
    ],
    [
        'text' => '缓存系统',
    ...
    [
        'text' => '消息通知',
        'link' => '/docs/{{version}}/notifications'
    ],
    [
        'text' => '扩展包开发',
    ...
    [
        'text' => 'HTTP 测试',
        'link' => '/docs/{{version}}/http-tests'
    ],
    [
        'text' => '浏览器测试 Dusk',
        'link' => '/docs/{{version}}/dusk'
    ],
    [
        'text' => '数据库测试',
        'link' => '/docs/{{version}}/database-testing'
    ],
    [
        'text' => '测试模拟器',
        'link' => '/docs/{{version}}/mocking'
    ],
    [
        'text' => 'Cashier 交易工具包',
